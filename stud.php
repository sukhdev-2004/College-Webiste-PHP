...
<body>
    ...
    <div class="login-container">
        ...
        <form method="POST">
            ...
            <a href="teacher.php" class="a1">Login As Teacher</a><br><br>
            <a href="admin_login.php" class="a1">Login As Admin</a>
            <input type="submit" name="login" value="Login"><br><br>
            No Have An Account ? <a class="a1" href="sign_up.php">Registration</a>
        </form>
    </div>
</body>
</html>
...
if(isset($_POST['login']))
{
    ...
    $login = mysqli_query($conn,"SELECT * FROM `stud` WHERE `email` = '$id' AND `pass` = '$pass'");
