...
<body>
    <div class="container">
        ...
        <?php
            ...
            $stud_query = mysqli_query($conn,"SELECT * FROM `stud` WHERE `status` = 'Accept'");
            $tot_stud = mysqli_num_rows($stud_query);
            $no = 1;

            if($tot_stud > 0)
            {
                echo '<div class="section-title">Students Applications</div>';
                echo '<table>';
                echo '<tr>
                        <th>Profile</th>
                        <th>Name</th>
            ...
            else
            {
                ?>
                    <table>
                        <tr>
                            <th>Student Accepted Applications</th>
                        </tr>
                        <tr>
            ...
            $teacher_query = mysqli_query($conn,"SELECT * FROM `teacher` WHERE `status` = 'Accept'");
            $tot_teacher = mysqli_num_rows($teacher_query);
            if($tot_teacher > 0)
            {
                echo '<div class="section-title">Teacher Applications</div>';
                echo '<table>';
                echo '<tr>
                        <th>Profile</th>
                        <th>Name</th>
            ...
            else
            {
                ?>
                    <table>
                        <tr>
                            <th>Teacher Accepted Applications</th>
                        </tr>
                        <tr>
                            <td>No Applications Found !!!</td>
                        </tr>
