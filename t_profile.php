...
<body>
    <div class="info-card">
        <div class="icon">
            <img src="./teacher_profile/<?php echo $row['profile'];?>" alt="" height="100px" width="100px">
        </div>
        <h2>Personal Information</h2>
        <p><span class="label">Name :</span> <?php echo $row['nm'] ?></p>
        <p><span class="label">Department :</span> <?php echo $row['department'] ?></p>
        <p><span class="label">Educational Qulification : <?php echo $row['education']; ?></span></p>
